...
<br><br>
	...
	$result = mysql_query("SELECT * FROM players WHERE ManagerUsername = '$manager' ORDER BY MinutesPlayed DESC LIMIT 10");
	...
	<div width="100%" style="background-color: #871414">
		<h2 class="text-center"> Minutes Played </h2>
	</div>	
	<br><br>
	<div class="container">
	<table class="table">
		...
		url: "http://localhost/chartData.php",
			...
			success: function(data) {
				...
				{	
						...
						score.push(data[i].MinutesPlayed);

...
<br><br>
	...
	$result = mysql_query("SELECT * FROM players WHERE ManagerUsername = '$manager' ORDER BY PointsScored DESC LIMIT 10");
		...
		url: "http://localhost/chartData.php",
			...
			success: function(data) {
				...
				{	
						...
						score.push(data[i].PointsScored);
